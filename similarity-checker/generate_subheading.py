...
import requests
import json
from similarity_checker_cosine import SemanticSimilarityChecker

# OpenRouter API Configuration
OPENROUTER_API_KEY = "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"
...
def generate_prompt_subheading(base_prompt, max_attempts=10):
    ...
    api_prompt = f"""Choose a particular topic from the broader topic {base_prompt}."""
