        ...
        messages=[
            {
                ...
                "content": f"you will generate encodings for a video animations. "
                           ...
                           "frames each frame can have graph containing some boxes and some connections for explaining"
                           "the topic. You define multiple frames to "
                           ...
                           "they flow from one point to the ohter. for example ccar can have multiple supply chain components' "
                           "visualisation: nodes: [(box, black, "
                           "basisc frame), (box, black, wheels), (box, black, car)] connections: (0, 1), (1, 2)."
                           ...
                           "the user understand the concept. A sample connection text miight look like node0,node1:node2;node2:node3;node3:node4 to mean"
                           "node0 and node1 points to node2, node1 points to node2 and node2 points to node3. Use dilimiter '$' between"
